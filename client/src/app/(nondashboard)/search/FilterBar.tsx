...
const FiltersBar = () => {
  ...
  return <div className="flex justify-between items-center py-5">
    <div className="flex justify-between items-center p-2">
        ...
        >
          ...
          <div className="flex items-center lg:ml-3 ml:0">
          <Input
          ...
          >
            <SelectTrigger className="w-full rounded-xl border- lg:ml-3 ml-0">
              <SelectValue>
          ...
          >
            <SelectTrigger className="w-full rounded-xl border-primary-400 lg:ml-3 ml-0">
              <SelectValue>
        ...
        >
          <SelectTrigger className="w-auto rounded-xl border-primary-400 lg:ml-3 ml-0 ">
