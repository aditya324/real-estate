    ...
    >
      <div className="max-w-6xl xl:max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 xl:px-16 text-center">
        <motion.div variants={itemVariants} className="my-12 text-center">
          ...
          <p className="mt-2 text-grey-500 max-w-3xl mx-auto">
          ...
          {[
            {
              ...
              description:"Browse through a wide range of rental listings with our intuitive search feature.",
            },
            {
              imageSrc: "/landing-icon-calendar.png",
              title:"book your Rental",
              description:"once youve found the perfect property, book it with ease using our secure platform.",
            },
            {
