...
const getCurrentResidences = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const residencesWithFormattedLoacation = yield Promise.all(properties.map((property) => __awaiter(void 0, void 0, void 0, function* () {
            var _a;
...
const addFavoriteProperty = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const tenanat = yield prisma.tenant.findUnique({
            where: { cognitoId },
            include: { favorites: true },
        });
        const propertyidNumber = Number(propertyId);
        const existingFavorietes = (tenanat === null || tenanat === void 0 ? void 0 : tenanat.favorites) || [];
