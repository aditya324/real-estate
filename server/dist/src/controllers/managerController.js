...
const updateManager = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        res
            .status(500)
            .json({ message: `Error updateing updateManager: ${error}` });
    }
});
...
const getManagerProperty = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const propertiesWithFormattedLoacation = yield Promise.all(properties.map((property) => __awaiter(void 0, void 0, void 0, function* () {
            var _a;
        ...
        res.json(propertiesWithFormattedLoacation);
    }
    catch (err) {
        res
            .status(500)
